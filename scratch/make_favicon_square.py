...
resized_img = square_img.resize((192, 192), Image.Resampling.LANCZOS)
resized_img.save('/Users/aditya/Downloads/MindGod/frontend/public/favicon.png')
print(f"Successfully created square transparent favicon of size: 192x192")
