...
export const Route = createFileRoute("/digital-shop")({
  component: DigitalShopPage,
});

function DigitalShopPage() {
  return (
    <div className="min-h-screen bg-[#f7fafc] text-slate-900 font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-teal-600 transition"
          >
